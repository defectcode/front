    ...
    return (
        <div>
            <div className="relative bg-cover bg-center min-h-screen bg-no-repeat bg-mobile sm:bg-desktop">
                <div className="absolute top-0 right-0 h-full w-full sm:w-[60%] bg-gradient-to-t sm:bg-gradient-to-r from-black/90 via-black/90 to-transparent sm:from-transparent sm:via-black/90 sm:to-black/90 flex items-end sm:items-center justify-center sm:justify-end p-4 sm:p-0 lg:pl-[150px]">
