  ...
  return (
    <div className="bg-black text-white flex min-h-screen py-10">
      <div className="max-w-screen-md px-4 lg:px-10">
        ...
        <h1 className="text-[26px] font-semibold mb-6 mt-[40px] md:mt-[80px] text-[#FFFFFF]">
          {privacyPolicyTitle}
        </h1>
        ...
        {/* Use of Data Section */}
        <h2 className="text-[24px] font-semibold mb-5 mt-10 text-[#FFFFFF] font-ekMukta">
          {useOfDataTitle}
        </h2>
        ...
        <h2 className="text-[24px]  font-bold mb-5 mt-10 text-[#FFFFFF]">
          {dataProtectionTitle}
        </h2>
        <p className="text-[16px] mb-2 leading-relaxed font-normal text-[#FFFFFF] font-ekMukta">
          {dataProtectionParagraph}
