        ...
        <nav className="bg-black bg-opacity-25 fixed top-0 w-full h-11 max-md:h-10 z-50 font-avenirRoman backdrop-blur-lg">
            <div className="max-w-screen-2xl mx-auto flex justify-between items-center px-2 py-2 max-md:mx-5">
                ...
                <ul className={`flex-col md:flex md:flex-row gap-10 text-lg md:text-[#D9D9D9] fixed md:static top-0 right-0 h-screen md:h-auto transition-transform transform ${isOpen ? 'translate-x-0 max-md:bg-gradient-to-r from-black to-dark-gray max-md:bg-opacity-100 text-white' : 'translate-x-full bg-opacity-50'} md:translate-x-0 md:w-auto w-2/3 pt-20 md:pt-0`}>
                    ...
                    <li className="md:mt-0 md:ml-0 ml-4 max-md:ml-10"><Link legacyBehavior href="/interactive"><a onClick={closeMenu} className="hover:text-gray-300 text-2xl md:text-lg">Interactive</a></Link></li>
                    <li className="mt-9 md:mt-0 md:ml-0 ml-4 max-md:ml-10"><Link legacyBehavior href="/about"><a onClick={closeMenu} className="hover:text-gray-300 text-2xl md:text-lg">About</a></Link></li>
                    <li className="mt-9 md:mt-0 md:ml-0 ml-4 max-md:ml-10"><Link legacyBehavior href="/crowdfunding"><a onClick={closeMenu} className="hover:text-gray-300 text-2xl md:text-lg">Crowdfunding</a></Link></li>
                    <li className="mt-9 md:mt-0 md:ml-0 ml-4 max-md:ml-10"><Link legacyBehavior href="/contact"><a onClick={closeMenu} className="hover:text-gray-300 text-2xl md:text-lg">Contact Us</a></Link></li>
                    <li className="mt-9 md:mt-0 md:ml-0 ml-4 max-md:ml-10"><Link legacyBehavior href="/careers"><a onClick={closeMenu} className="hover:text-gray-300 text-2xl md:text-lg">Careers</a></Link></li>
