    ...
    return (
        <nav className="bg-gray-900 bg-opacity-40 fixed top-0 w-full z-50">
            <div className="max-w-screen-2xl mx-auto flex justify-between items-center px-4 py-4 max-md:mx-5">
                ...
                <ul className={`flex-col md:flex md:flex-row gap-10 text-lg text-gray-400 fixed md:static top-0 right-0 h-screen md:h-auto bg-opacity-50 transition-transform transform ${isOpen ? 'translate-x-0 bg-black text-white' : 'translate-x-full'} md:translate-x-0 md:w-auto w-2/3 pt-20 md:pt-0`}>
