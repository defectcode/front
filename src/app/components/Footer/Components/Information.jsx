...
const Information = () => {
  return (
    <div className="flex flex-row justify-between items-center max-w-[1300px] mx-auto w-full text-white px-4 max-lg:flex-col max-lg:justify-around lg:items-start max-md:items-center">
      <Description />
