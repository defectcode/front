  ...
  return (
    <div className="flex flex-col space-y-2 w-5/6 max-md:w-full max-lg:p-0 max-lg:space-y-2 max-md:-mb-32">
      ...
      <div className="flex items-center max-md:justify-between text-xl" style={{ fontFamily: 'Avenir Roman, sans-serif', fontWeight: 400 }}>
        ...
        <div className="flex gap-2 text-lg max-sm:text-md ml-[170px] max-md:ml-0 max-md:mr-0 max-md:text-[16px]" style={{ fontFamily: 'Avenir, sans-serif' }}>
      ...
      {content.status === 'Process' ? (
        <p className='flex items-end text-xl lg:text-md mb-3 md:mb-0 gap-1 max-lg:gap-[2px] whitespace-nowrap' style={{ fontFamily: 'Ek Mukta, sans-serif' }}>
          ...
          <span className="font-semibold max-md:font-semibold max-md:text-[11px]">{content.supportersCount}</span>
